    ...
    <div className="w-full max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6 lg:py-8">
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="p-4 sm:p-6 space-y-4">
            ...
            <div>
              ...
              <InputText
                ...
                placeholder="otomatik üretilir, boş bırakabilirsiniz"
              />
            </div>
            <div>
        ...
        <div className="flex flex-wrap gap-2">
          <Button type="submit" label={loading ? "Kaydediliyor..." : "Kaydet"} loading={loading} disabled={loading} className="bg-primary-500 hover:bg-primary-600 border-primary-500" icon="pi pi-check" iconPos="left" />
