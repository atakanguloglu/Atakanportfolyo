  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="container mx-auto px-4 py-12 lg:py-20">
        ...
        {projects.length === 0 ? (
          <p className="text-center text-gray-500 py-12">Henüz yayınlanmış proje yok.</p>
        ) : (
              ...
              >
                ...
                <div className="p-8">
                  ...
                  <Link
                    ...
                    className="p-button p-button-outlined mt-5 text-primary-500 font-bold no-underline inline-flex items-center"
                  >
                    Örnek Çalışma
